<template>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Minimalna Temperatura Powietrza</th>
      <th scope="col">Maksymalna Temperatura Powietrza</th>
      <th scope="col">Minimalna Temperatura Gleby</th>
      <th scope="col">Maksymalna Temperatura Gleby</th>
    </tr>
  </thead>
  <tr v-for="record in page" :key="record.id">
    <th scope="row">{{record.dataPomiaru}}</th>
    <td>{{record.minimalnaTemperaturaPowietrza}}&deg;C</td>
    <td>{{record.maksymalnaTemperaturaPowietrza}}&deg;C</td>
    <td>{{record.minimalnaTemperaturaGleby}}&deg;C</td>
    <td>{{record.maksymalnaTemperaturaGleby}}&deg;C</td>
</tr>
  <tbody>
  </tbody>
</table>
